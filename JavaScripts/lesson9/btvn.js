...
//BAI 2, TIM EMAIL THEO FIRST NAME VA LAST NAME

// const findEmail = prompt(' Enter the name :');


// const user = users.find( user => (user.first_name + user.last_name)  === findEmail);
...
// BAI 3, DEM SO LUONG USER > 50 TUOI


  
//   const count = users.reduce((sum, user) => {
//     if (user.age > 50) {
//       return sum + 1;
//     }
//     return sum;
...
//BAI 5, DEM SO LUONG USER THEO NGANH NGHE TUONG UNG


let input = prompt('nhap nganh nghe can tim so luong:');
